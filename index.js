/* Give to this script the appropriate .csv and it will generate the static mappings 
...
.then(( obj )=>{
    ...
    fs.writeFileSync('./testUrls.html.txt', testUrls, 'utf8') // for uploading the file in Redmine that doesn't accept .html
})